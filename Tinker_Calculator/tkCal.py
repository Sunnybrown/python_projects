...
class Calculator:
    def __init__(self,master):
        ...
        Button(width=8,height=4,text='9',relief='flat',bg='white',command=lambda:self.show(9)).place(x=90 ,y=275)
        ...
        Button(width=8,height=4,text='c',relief='flat',command=self.clear).place(x=0 ,y=350)
